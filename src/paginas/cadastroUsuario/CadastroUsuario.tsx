            ...
            <Grid item xs={6} alignItems='center'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        ...
                        <TextField value={confirmarSenha} onChange={(e: ChangeEvent<HTMLInputElement>) => confirmarSenhaHandle(e)} id='confimarSenha' label='confimarSenha' variant='outlined' name='confimarSenha' margin='normal' type='password' fullWidth />
